...
class SchedulerTools:
    ...
    def __init__(self):
        ...
        self.schedule_task_tool = StructuredTool.from_function(
            name="schedule_task",
        ...
        self.list_scheduled_tasks_tool = StructuredTool.from_function(
            name="list_scheduled_tasks",
            func=self.list_scheduled_tasks,
            description="List all currently scheduled tasks with their IDs and next run times.",
        )

        self.remove_scheduled_task_tool = StructuredTool.from_function(
