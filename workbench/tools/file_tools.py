...
class FileTools:
    ...
    def __init__(self):
        ...
        self.append_file_tool = StructuredTool.from_function(
            name="append_file",
        ...
        self.list_files_tool = StructuredTool.from_function(
            name="list_files",
        ...
        self.search_string_in_files_tool = StructuredTool.from_function(
        ...
        self.get_file_info_tool = StructuredTool.from_function(
            name="get_file_info",
        ...
        self.find_duplicate_files_tool = StructuredTool.from_function(
    ...
    def find_duplicate_files(
        ...
        try:
            ...
            if exclude_dirs is None:
                exclude_dirs = settings.DEFAULT_IGNORE_DIRS
            if exclude_extensions is None:
                exclude_extensions = settings.DEFAULT_IGNORE_FILES
    ...
    def search_string_in_files(
        ...
        disable_smart_ignore=settings.DISABLE_SMART_IGNORE,
        ...
        def _search_with_mmap(file_path, search_bytes, ignore_case, base_directory):
            ...
            # Normalize path if self is available
            try:
                file_path = self._normalize_path(file_path.strip())
            except Exception:
                file_path = file_path.strip()
        ...
        if disable_smart_ignore:
            ...
            ignore_dirs = settings.DEFAULT_IGNORE_DIRS.copy()
            if additional_ignore_dirs:
                ignore_dirs.update(additional_ignore_dirs)
            ignore_files = settings.DEFAULT_IGNORE_FILES.copy()
