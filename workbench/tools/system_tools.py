...
class SystemTools:
    ...
    def __init__(self) -> None:
        self.execute_command_tool = StructuredTool.from_function(
        ...
        self.get_system_info_tool = StructuredTool.from_function(
        ...
        self.get_running_processes_tool = StructuredTool.from_function(
            name="get_running_processes",
            func=lambda **kwargs: self.list_processes(),
            args_schema={},
        ...
        self.get_disk_usage_tool = StructuredTool.from_function(
            name="get_disk_usage",
            func=lambda **kwargs: self.get_disk_usage(),
            args_schema={
                "path": {
                    "type": "string",
        ...
        self.get_memory_usage_tool = StructuredTool.from_function(
            name="get_memory_usage",
            func=lambda **kwargs: self.get_memory_usage(),
            args_schema={},
        ...
        self.get_network_info_tool = StructuredTool.from_function(
            name="get_network_info",
            func=lambda **kwargs: self.get_network_info(),
            args_schema={},
    ...
    def execute_command(
        self,
        command: str,
        timeout_seconds: int = settings.COMMAND_TIMEOUT,
        shell: bool = True,
        cwd: str = ".",
    ) -> str:
